    ...
    <div className="min-h-screen bg-[#0C0C0D] pt-16">
      <div className="container" style={{ maxWidth: '720px', paddingTop: '72px', paddingBottom: '72px' }}>
        ...
        <div className="flex flex-col gap-4">
          <p className="text-[14px] font-light text-[#B8B8B2] leading-[1.75]">These terms apply to Qordova Labs Inc Pte. Ltd. and the Qordova.com website.</p>
          <p className="text-[14px] font-light text-[#B8B8B2] leading-[1.75]">By accessing this website, you agree that the content is provided for informational purposes only and does not constitute a commercial offer, binding agreement, or product warranty.</p>
          <p className="text-[14px] font-light text-[#B8B8B2] leading-[1.75]"
             dangerouslySetInnerHTML={{ __html: 'For questions, contact <a href="mailto:contact@qordova.com" className="text-[#C9A84C] hover:underline underline-offset-4">contact@qordova.com</a>.' }} />
        </div>
        <div className="mt-10">
